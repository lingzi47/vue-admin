  ...
  <div>
    ...
    <div class="page-content">
      ...
      >
        ...
        <el-table-column prop="province_name" label="省" align="center">
        </el-table-column>
        <el-table-column prop="city_name" label="市" align="center">
        </el-table-column>
        <el-table-column prop="area_name" label="区/县" align="center">
        </el-table-column>
        <el-table-column prop="pre_count" label="楼盘数量" align="center">
        </el-table-column>
        <el-table-column prop="ele_count" label="设备数量" align="center">
        </el-table-column>
...
import { listRegion, RegionDel } from "@/request/api";
