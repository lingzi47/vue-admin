  ...
  <div>
    <div class="topserch">
      <el-form :inline="true">
        ...
        <el-form-item label="设备编号">
          <el-input style="width: 180px" v-model="name" clearable placeholder="请输入设备编号"></el-input>
        </el-form-item>
    ...
    <div class="page-content">
      <el-table class="tab-bar" :data="list" border stripe @selection-change="getSelection">
        ...
        <el-table-column prop="eleNum" label="设备编码" align="center"></el-table-column>
...
import { eleList, eleDel } from "@/request/api";
export default {
  components: {
    addData
  },
